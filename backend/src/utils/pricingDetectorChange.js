...
function buildChangeSummary(audit, newReport, pricingDiff) {
    ...
    return {
        pricingDiff,
        reportChanged: stableStringify(previousReport || {}) !== stableStringify(newReport || {}),
        recommendationDiff: {
...
export async function detectPricingChanges() {
    ...
    for (const audit of audits) {
        try {
            ...
            const reportChanged = stableStringify(audit.outputResult || {}) !== stableStringify(newReport || {});
